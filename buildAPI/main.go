...
func main() {
	...
	courses = append(courses, Course{CourseId: "2",
		CourseName: "ReactJs", CoursePrice: 299, Author: &Author{
			Fullname: "Altamash", Website: "lco.dev",
		}})
	courses = append(courses, Course{CourseId: "4",
		CourseName: "Flutter", CoursePrice: 699, Author: &Author{
			Fullname: "Altamash", Website: "lco.dev",
		}})
...
func getOneCourse(w http.ResponseWriter, r *http.Request) {
	...
	//loop through the courses,find matching id, return response
